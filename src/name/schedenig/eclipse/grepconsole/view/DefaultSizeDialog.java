...
/**
 * A dialog that can provide a default size for use when no preferred size has
 * been persisted in the dialog settings.
 * 
 ...
 * @author msched
 */
public class DefaultSizeDialog extends TrayDialog
{
